...
var adminEmbed_default = commandModule({
  ...
  async execute(ctx) {
    ...
    const modal = new ModalBuilder().setCustomId(`adminEmbedModal`).setTitle("\u{1F58B}\uFE0F Build Embed (Step 1)");
    modal.addComponents(
