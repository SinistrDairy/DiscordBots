...
var add_character_default = commandModule({
  type: CommandType.Slash,
  name: "startcharacter",
  description: "\u{1F3AD} Begin your Nightreign journey with a custom class and name.",
  plugins: [
    publishConfig({
  ...
  async execute(ctx) {
    ...
    const confirmBtn = new ButtonBuilder().setCustomId(confirmId).setLabel("Delete Old Character").setStyle(ButtonStyle.Danger);
...
export {
  add_character_default as default
};
