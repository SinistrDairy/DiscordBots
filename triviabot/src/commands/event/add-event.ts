import {PermissionsBitField, ApplicationCommandOptionType, PermissionFlagsBits} from "discord.js";
...
export default commandModule({
  ...
  options: [
    ...
    },
    {
      ...
      name: "points",
      description:
        "Enter in the points used in this event separated by a comma with no spaces.",
      required: true,
    },
    {
      type: ApplicationCommandOptionType.String,
    ...
    },
    {
      ...
      name: "rules",
      description:
        "Enter the rules for the event separated by a comma with no spaces.",
      required: true,
    },
    {
      type: ApplicationCommandOptionType.String,
  ...
  execute: async (ctx) => {
    ...
    // console.log(ePointArray, eRulesArray, eTagsArray)
